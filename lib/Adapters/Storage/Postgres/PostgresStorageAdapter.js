...
class PostgresStorageAdapter {
  ...
  getAllClasses() {
    return this._ensureSchemaCollectionExists().then(() => this._client.map('SELECT * FROM "_SCHEMA"', null, row => toParseSchema(_extends({ className: row.className }, row.schema))));
  }
